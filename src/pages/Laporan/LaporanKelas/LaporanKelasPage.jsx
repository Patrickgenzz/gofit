...
import { getLaporanKelas, getFindLaporanAktivitasKelas } from "../../../utils/Api";
import ReactToPrint from "react-to-print";
import Swal from "sweetalert2";

export default class LaporanKelasPage extends Component {
  constructor(props) {
    super(props);
  ...
  handleSearch = (tahun, bulan) => {
    getFindLaporanAktivitasKelas(tahun, bulan)
      .then((result) => {
      ...
      <div style={{ display: "flex" }}>
        ...
        <section className="home-section">
          <div style={{ display: "flex", marginTop: "18px" }}>
            <div style={{ display: "flex" }}>
              <h1 style={{ margin: "auto", marginRight: "15px" }}>LAPORAN KELAS</h1>
                ...
                <tr>
                  <th colSpan="4" style={tableHeaderStyles}>
                    <div className="header-content">
                      ...
                      <br />
                      <div style={reportTitleStyles}>LAPORAN AKTIVITAS KELAS BULANAN</div>
