...
export default class CetakKelasReguler extends Component {
  constructor(props) {
    super(props);
    this.state = {
      kelas: props.kelas,
  ...
  displayKelas = () => {
    ...
    ctx.font = "40px Arial";
    ctx.fillStyle = "#000000";
    ctx.fillText("STRUK PRESENSI KELAS REGULER", 25, 120);
    ...
    ctx.fillText("TARIF          : " + "Rp." + formatMoney(this.state.kelas.TARIF_KELAS), 512, 240);
    ctx.fillText("SISA DEPOSIT   : " + "Rp." + formatMoney(this.state.kelas.SISA_DEPOSIT_UANG), 25, 240);
  };
  ...
  handlePrint = () => {
    ...
    link.download = "REGULER_" + nama + ".jpg";
    link.href = dataURL;
